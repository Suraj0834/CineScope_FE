...
import com.mrnoone.cinescope.databinding.ActivityHomeBinding
import com.mrnoone.cinescope.ui.auth.LoginActivity
import com.mrnoone.cinescope.ui.details.MovieDetailActivity
import com.mrnoone.cinescope.ui.profile.ProfileActivity
...
import com.mrnoone.cinescope.util.NetworkUtils
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (NetworkUtils.isNetworkAvailable(this)) {
            ...
            Snackbar.make(binding.root, com.mrnoone.cinescope.ailang.AiLang.t("error_generic"), Snackbar.LENGTH_LONG).show()
        }

        // Listen for language changes - update UI instead of recreating
        com.mrnoone.cinescope.ailang.AiLang.addListener {
            applyTranslations()
        }
    }
    ...
    private fun applyTranslations() {
        ...
        binding.apply {
            etSearch.hint = com.mrnoone.cinescope.ailang.AiLang.t("search_movies")
            chipTrending.text = com.mrnoone.cinescope.ailang.AiLang.t("trending")
            chipPopular.text = com.mrnoone.cinescope.ailang.AiLang.t("popular")
            chipTopRated.text = com.mrnoone.cinescope.ailang.AiLang.t("top_rated")
            chipAction.text = com.mrnoone.cinescope.ailang.AiLang.t("action")
            chipComedy.text = com.mrnoone.cinescope.ailang.AiLang.t("comedy")
            chipDrama.text = com.mrnoone.cinescope.ailang.AiLang.t("drama")
            chipSciFi.text = com.mrnoone.cinescope.ailang.AiLang.t("sci_fi")
            chipThriller.text = com.mrnoone.cinescope.ailang.AiLang.t("thriller")
            chipWatchlist.text = com.mrnoone.cinescope.ailang.AiLang.t("my_watchlist")
        }
    }
