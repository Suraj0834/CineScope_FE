...
import com.mrnoone.cinescope.databinding.ActivityMovieDetailBinding
import com.mrnoone.cinescope.ui.chat.ChatActivity
...
class MovieDetailActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerViews() {
        ...
        castAdapter = CastAdapter { castMember ->
            ...
            val intent = Intent(this, com.mrnoone.cinescope.ui.person.PersonDetailActivity::class.java)
    ...
    private fun displayMovieDetail(detail: com.mrnoone.cinescope.data.model.MovieDetail) {
